...
const Explanation = () => {
  return (
    <div className="px-50 py-30">
      <h1 className="flex items-center justify-center text-4xl font-semibold pb-10">
        Charges explained
      </h1>
      <div className="flex px-10">
        <div className="w-6/12 p-6 charge">
        ...
        <div className="w-6/12 p-6 charge">
          ...
          <p>
            ...
            of ₹0.25 per transaction on the CDSL fee. <br />
          ...
          <p>
            ...
            than ₹4,00,000. To learn more about BSDA, <br />
      ...
      <div className="px-10 pb-20 pt-10">
        <h3 className="text-lg font-semibold pb-6">Disclaimer</h3>
